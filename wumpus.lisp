...
(defparameter *nodes-num* 30)
(defparameter *edges-num* 45)
...
(defun make-edge-list ()
	(apply #'append (loop repeat *edges-num* 
...
(defun make-city-edges ()
	(let* ((nodes (loop for i from 1 to *nodes-num* collect i))
...
(defun make-city-nodes (edge-alist)
	(let ((wumpus (random-node))
		...
		(loop for n from 1 to *nodes-num*
